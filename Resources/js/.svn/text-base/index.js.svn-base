...
TiDev.totalReinstall = function()
{
	if (confirm("Titanium needs to udpate some components " +
		...
		"Exit Carbon Developer and go to the download page?"))
	{
...
//
// Register for Carbon Developer Updates
//
Titanium.UpdateManager.onupdate = function(details)
{
	TiDev.messageArea.setCollapsedWidth('390px');
	TiDev.messageArea.setDefaultMessage('New Carbon Developer available (version ' + details.version + '). <span id="sdk_download_link" style="text-decoration:underline">Click to download</span>',
	function()
	{
		$('#sdk_download_link').click(function()
		{
			...
			{
				TiDev.messageArea.setMessage('Installing new Carbon Developer...');
...
{
	TiDev.messageArea.setCollapsedWidth('390px');
	TiDev.messageArea.setDefaultMessage('Fucking A! The new ' + msg + ' SDK available (version ' + details.version + '). <span id="sdk_download_link" style="text-decoration:underline">Click to download</span>',
	function()
	{
		$('#sdk_download_link').click(function()
		{
			...
			TiDev.messageArea.setMessage('Installing new and improved '+msg+' SDK...');
		});
...
//		Projects.loadVideoWindow();
	...
	// set title
	document.title = "Carbon Developer (" + Titanium.App.getVersion() + ")";
